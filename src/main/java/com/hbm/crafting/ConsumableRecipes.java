...
public class ConsumableRecipes {
	...
	public static void register() {
		...
		//we removed the old syringes bruh
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.syringe, 1), new Object[] { " P ", " C ", " B ", 'B', Item.getItemFromBlock(Blocks.iron_bars), 'C', ModItems.cell_empty, 'P', IRON.plate() });
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.combat_syringe, 1), new Object[] { " P ", " C ", " B ", 'B', Blocks.iron_bars, 'C', ModItems.rod_empty, 'P', IRON.plate() });
		...
		CraftingManager.addShapelessAuto(new ItemStack(ModItems.syringe_taint), new Object[] { ModItems.bottle2_empty, ModItems.combat_syringe, ModItems.ducttape, ModItems.powder_magic, SA326.nugget(), Items.potionitem });
		...
		//Med bags - old syringe recipes commented out
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.auto_drip, 1), new Object[] { " R ", "TCT", " S ", 'R', ANY_RUBBER.ingot(), 'T', ModItems.iv_empty, 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.BASIC), 'S', ModItems.syringe });
