...
public class RenderFrackingTower extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float f) {
		...
		bindTexture(tileEntity.getWorldObj().provider.dimensionId == SpaceConfig.czechoslowakiaDimension ? ResourceManager.fracking_tower_buurman_tex : ResourceManager.fracking_tower_tex);
